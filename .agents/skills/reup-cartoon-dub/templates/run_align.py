"""Whisper align template. Script as ground truth. NO initial_prompt."""
...
def main() -> int:
    ...
    segs, info = model.transcribe(
        str(AUDIO), language="vi", beam_size=5,
    ...
    print(f"Whisper: {len(whisper_words)} words, dur={info.duration:.2f}s")
    ...
    for tag, i1, i2, j1, j2 in sm.get_opcodes():
        if tag == "equal":
            ...
            src_n = max(i2 - i1, 0); dst_n = max(j2 - j1, 0)
