...
**Related:** see `feedback_whisper_vn_caption_verify.md` — similar but different failure mode (that one is about whisper mis-transcription, this one is about TTS mis-pronunciation that whisper catches).
