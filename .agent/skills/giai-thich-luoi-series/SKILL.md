---
name: giai-thich-luoi-series
description: "Series Giải Thích Kiểu Lười — bản Việt của Casually Explained: video explainer người que deadpan với dàn 4 nhân vật cố định (Anh Thuốc Lá / Chú Nón Cối / Bác Cục Gạch / Chú Bát Phở), mỗi nhân vật có topic matrix + voice riêng, character bible LOCKED không redesign. Dùng khi user nhắc Giải Thích Kiểu Lười, Casually Explained VN, hoặc muốn explainer với cast này."
---
