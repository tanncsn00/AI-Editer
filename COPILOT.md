# Vibe Editing - Copilot Agent Instructions
...
> **Project memory:** See [`.agents/memory/MEMORY.md`](.agents/memory/MEMORY.md) — rules and feedback learned on this project. Read before making any video.
