...
export const MatNgonChieuMoThumbnail: React.FC = () => (
  <AbsoluteFill style={{ background: BG }}>
    ...
    <AbsoluteFill style={{ padding: 62, display: "flex", flexDirection: "column", justifyContent: "center", gap: 40 }}>
      ...
      <Side who="NGƯỜI MỚI NGHE" text={"“CHỊ SẼ PHẢN HỒI\nSỚM NHÉ.”"} color={TEXT} size={46} />
      <div style={{ textAlign: "center", fontSize: 42, color: MUTE, lineHeight: 0.6 }}>▼</div>
      <Side who="TU SĨ LÂU NĂM NGHE" text={"“THIÊN ĐẠO\nCHƯA QUYẾT.”"} color={RED} size={58} />
