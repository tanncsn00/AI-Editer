...
export const Top10ClaudeCodePluginsThumbnail: React.FC = () => {
  return (
      ...
      <svg width={W} height={H} style={{ position: "absolute", inset: 0 }}>
        ...
        <g transform={`translate(${W / 2}, 1110)`}>
          <text x={0} y={0} fontSize={42} fill={TEXT_PRI} textAnchor="middle" fontFamily="'Be Vietnam Pro', sans-serif" fontWeight={700} fontStyle="italic">
            chính chủ + cộng đồng · Claude bay Sao Hỏa
          </text>
        </g>
        ...
        <g transform={`translate(${W / 2}, 1340)`}>
          {[
            { lbl: "claudeclaw", color: GOLD },
            { lbl: "superpowers", color: ACCENT_VIOLET },
            { lbl: "ccusage", color: GREEN },
            { lbl: "firecrawl", color: ORANGE },
            { lbl: "router", color: ACCENT_CYAN },
          ].map((c, i) => (
